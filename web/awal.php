...
<body id="daftar">
    <div class="container">
        ...
        <p class="back"><a href=""><i class="fas fa-chevron-left"></i><b>Kembali</b></a></p>
        <p class="p1">Silahkan pilih akun anda</p>
        <button class="pengurus" style="position: relative; top:-9px;" onclick="window.location='register(admin).php'">
            <i class="fas fa-user-tie" style="font-size: 4rem; padding-bottom: 5px; "></i>
            <p>Akun untuk pengurus kelas,<br>admin, bendahara</p>
        </button>
        <button class="siswa" onclick="window.location='register.php'">
            <i class="fas fa-user" style="font-size: 4rem; padding-bottom: 5px;"></i>
            <p>Akun untuk partisipan kelas</p>
        </button>
