...
import com.kelompok.emajer.Model.login.LoginData;
...
public class SessionManager {
    ...
    public void createLoginSession(LoginData user){
        ...
        editor.putString(ID_KELAS, user.getIdkelas());
//        System.out.println(user.getName());
        editor.commit();
    }

//    public void createRegisterSession(RegisterData1 user){
//        editor.putBoolean(IS_LOGGED_IN, true);
//        editor.putString(USER_ID, user.getUserId());
//        editor.putString(USERNAME, user.getUsername());
//        editor.putString(NAME, user.getName());
...
//    }
    ...
    public void setIdKelas(String isLoggedin){
        SharedPreferences.Editor edit = sharedPreferences.edit();
        edit.putString(ID_KELAS, isLoggedin);
        edit.commit();
    }
    ...
    public String getIdKelas(){ return sharedPreferences.getString(ID_KELAS, ""); }
}
